...
- the found-victims chip in the app bar
...
green = connected / mission success, amber = warning, red = the victim marker, the live-camera dot
...
Block category hues moved off two collisions: sensing was hue 0, the same red as a victim marker in
